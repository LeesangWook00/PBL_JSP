...
| 화면 | 경로 | 캡쳐 이미지 |
|------|------|-------------|
| 홈 | `index.jsp` | ![홈 화면](src/main/image/home.png) |
| 로그인 | `html/login.html` | ![로그인 화면](src/main/image/login.png) |
| 회원가입 | `html/signup.html` | ![회원가입 화면](src/main/image/signup.png) |
| 피드 목록 | `jsp/main.jsp` | ![피드 목록 화면](src/main/image/feed.png) |
| 게시글 상세 | `jsp/feedView.jsp?no=1` | 추후 추가 |
| 글쓰기 | `html/feedAdd.html` | ![글쓰기 화면](src/main/image/feedadd.png) |
| 정보수정 | `jsp/edit.jsp` | ![정보수정 화면](src/main/image/edit.png) |
| 회원목록 | `jsp/userList.jsp` | 추후 추가 |
